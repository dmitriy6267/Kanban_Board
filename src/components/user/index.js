    ...
    return (
      <>
        <div className="user">
          ...
          <svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg" className={classNamesArrow} onClick={this.onUserClick}>
        ...
        <div className={classNamesUserMenu}>
          ...
          <div className="user-menu">
            <a href="profile" className="user-menu__text">Profile</a>
            <a href="/logOut" className="user-menu__text">Log Out</a>
          </div>
        </div>
      </>
    )
